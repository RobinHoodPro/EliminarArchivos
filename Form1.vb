...
Public Class FrmDelArch
    ...
    Private Sub BtCarpeta_Click(sender As Object, e As EventArgs) Handles BtCarpeta.Click
        If selectFolder() Then listadoFolders() : eliminarArchivos()
    End Sub
    ...
    '
    'Eliminar Archivos Que Se Encuentran En La Carpeta Seleccionada Dependiendo De Los Filtros Seleccionados
    '
    Private Sub eliminarArchivos()
    ...
    '
    'Eliminar Los Archivos Que Se Encuentran En La Lista Pasada Como Parametro Y Actualizar La Barra De Progreso Circular
    '
    Private Sub archivosCarpeta(ByVal listaArchivos As List(Of String))
